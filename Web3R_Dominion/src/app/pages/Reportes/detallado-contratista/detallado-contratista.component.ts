...
@Component({
  selector: 'app-detallado-contratista',
  templateUrl: './detallado-contratista.component.html',
  styleUrls: ['./detallado-contratista.component.css']
})

export class DetalladoContratistaComponent implements OnInit {
